...
class _PaymentSlipState extends State<PaymentSlip> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: _cartViewModel.cartItems.isEmpty ? const Center(child: Text('No items in cart')) : SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Column(
                children: _cartViewModel.cartItems.map((item) => 
                  Card(
              ...
              Row(
                ...
                children: [
                  ...
                  Text(
                    formatter.format(_cartViewModel.cartItems.fold(0.0, (previousValue, item) => previousValue + (item.price! * item.amount))),
              ...
              Row(
                ...
                children: [
                  ...
                  Text(
                    formatter.format(_cartViewModel.cartItems.fold(0.0, (previousValue, item) => previousValue + (item.price! * item.amount)) + deliveryFee),
